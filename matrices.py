...
tipo = input("vectores o matrices: ")
if tipo == "vectores":
  ...
  pregunta = int(input("Producto punto (1) o producto por escalar (2): "))
  punto = vec_1 * vec_2

  if pregunta == 1:
    print("El resultado del producto punto es:", punto)
  elif pregunta ==2:
    pregunta_esc = int(input("Vector que sea multiplicar por el escalar: "))
    if pregunta_esc == 1:
  ...
  # Pedir qué quiere
  pregunta = int(input("sumar(1), restar(2) o producto por un escalar(3) para matrices: "))
  ...
  if pregunta == 1:
   ...
   pregunta_esc = int(input("multiplicar la matriz 1 o 2 por el escalar: "))
   if pregunta_esc == 1:
...
pregunta = int(input("matriz de la cual desea obtener la i-ésima fila (1 o 2): "))
if pregunta == 1:
  ...
  print("Número no válido")
=======
# Define la clase vector, producto escalar y por escalar
class Vector:
    def __init__(self, x, y, z):
        self.x = x
        self.y = y
...
if pregunta == 1:
  ...
  #Jhon S me ayudó
>>>>>>> f4df779081a87b43d034367b825014c44688901f
